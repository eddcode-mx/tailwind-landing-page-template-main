    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            ...
            <div className="text-sm text-gray-600">
              <a href="https://www.mitienditajuntos.com/terminos-y-condiciones/index.php" className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Términos y condiciones</a> · <a href="https://www.mitienditajuntos.com/aviso-de-privacidad/index.php" className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Política de privacidad</a>
            </div>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            {/* <h6 className="text-gray-800 font-medium mb-2">Contactanos</h6>
            <p className="text-sm text-gray-600 mb-4">Mandanos tu correo</p> */}
            {/* <form>
              <div className="flex flex-wrap mb-4">
                <div className="w-full">
                  <label className="block text-sm sr-only" htmlFor="newsletter">Correo</label>
                  <div className="relative flex items-center max-w-xs">
                    <input id="newsletter" type="email" className="form-input w-full text-gray-800 px-3 py-2 pr-12 text-sm" placeholder="correo electrónico" required />
                    <button type="submit" className="absolute inset-0 left-auto" aria-label="Subscribe">
                      <span className="absolute inset-0 right-auto w-px -ml-px my-2 bg-gray-300" aria-hidden="true"></span>
                      <svg className="w-3 h-3 fill-current text-red-600 mx-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; 2021-2024 Mi tiendita juntos. Todos los derechos reservados.</div>
